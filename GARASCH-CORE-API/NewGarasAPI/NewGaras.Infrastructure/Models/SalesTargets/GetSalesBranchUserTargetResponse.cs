...
{
    [DataContract]
    public class GetSalesBranchUserTargetResponse
    {
        List<ViewSalesBranchUserTarget> salesBranchUserTargets;
        bool result;
        List<Error> errors;


        [DataMember]
        public List<ViewSalesBranchUserTarget> SalesBranchUserTargets
        {
            get
            {
